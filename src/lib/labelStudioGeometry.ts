...
export const LABEL_STUDIO_PRINT_GEOMETRY_REV = 55

/** DYMO TextObject on LW Durable prints ~8% larger than the canvas ShrinkToFit preview. */
export const DURABLE_STUDIO_TEXT_PRINT_SCALE = 0.90
