...
const READER_ID = 'reorder-qr-reader'
    ...
    <div className="qr-scanner-overlay">
      ...
      {cameraError ? (
        <div className="qr-scanner-error">
          <p>{cameraError}</p>
          <p className="qr-scanner-error-hint">Allow camera in browser settings and try again.</p>
        </div>
      ) : (
        <div className="qr-scanner-stage">
          <div id={READER_ID} ref={containerRef} className="qr-scanner-reader" />
